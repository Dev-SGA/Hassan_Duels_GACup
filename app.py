...
def compute_touch_stats(df_touches: pd.DataFrame) -> dict:
...
touch_stats = compute_touch_stats(df_touches)
...
with col_bottom_right:
    ...
    st.markdown("**Touches**")
    t1, t2 = st.columns(2)
    t1.metric("Total Touches", touch_stats["total_touches"])
    t2.metric("Final Third Touches", touch_stats["final_third_touches"])
